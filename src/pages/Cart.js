                            ...
                            return (
                                <li className='mb-12' key={product._id}>
                                    <div className='flex item-center justify-between'>
                                        ...
                                        <div><span>$ {getSum(product._id, product.price)}</span></div>
                                        <div>
                                            <button onClick={() => { handleDelete(product._id) }} className='bg-red-700 px-4 py-2 rounded-full leading-none'>Delete</button>
                                        </div>
                                    </div>
                                </li>
                            )
